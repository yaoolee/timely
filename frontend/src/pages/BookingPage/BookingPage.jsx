...
export default function BookingPage() {
  // State for the *displayed* month. Defaults to today.
  const [currentDate, setCurrentDate] = useState(() => new Date());
  
  // State for the *selected* date & time
  ...
  const availableTimes = [
    ...
    '2:00 PM', '4:00 PM', '5:00 PM', '7:00 PM'
  ];
  ...
  const handleDateSelect = (day) => {
    ...
    setBookingConfirmed(false); // Reset confirmation
  };
  ...
  // --- Helper to format the confirmed date ---
      ...
      {bookingConfirmed && (
        <div className="confirmation-card">
          ...
          <p className="confirmation-subtitle">
            Your booking with Mr. Cooper has been scheduled for {getFormattedDate(selectedDate)} at {selectedTime}.
          </p>
