...
const dummyServices = [
  {
    ...
    duration: '60 mins',
    price: 500,
    serviceInfo: 'Timely provides a very simple scheduling for students to connect with tutors. Instead of back-and-forth emails or messages, everything happens in one place.',
      ...
      <main className="service-content">
        <div className="container">
          ...
          <div className="service-grid">
            {/* Here we map over the dummy data array.
              For each item, we render a ServiceCard component.
            */}
